    ...
    <div class="col-md-8 offset-md-2">
        ...
        <form action="{{ route('boxes.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" class="form-control @error('max_weight') is-invalid @enderror">
                <input type="number" step="0.01" class="form-control @error('max_weight') is-invalid @enderror" id="max_weight" name="max_weight" value="{{ old('max_weight') }}">
                @error('max_weight')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
